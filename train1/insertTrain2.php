    ...
    <center>
      <form  name="trainForm" action="<?php echo $_SERVER['PHP_SELF'];?>" method="post" onsubmit="return validateForm()">
        <table class="table">
          ...
          <tr class="row">
            <td class="cell">Train Running Status:</td>
            <td class="cell">
                Sunday:<input type="checkbox" name="sun" value="1">&nbsp;
                Monday:<input type="checkbox" name="mon" value="1">&nbsp;
                Tuesday:<input type="checkbox" name="tue" value="1">&nbsp;
                Wednesday:<input type="checkbox" name="wed" value="1">&nbsp;
                Thursday:<input type="checkbox" name="thu" value="1">&nbsp;
                Friday:<input type="checkbox" name="fri" value="1">&nbsp;
                Saturday:<input type="checkbox" name="sat" value="1">
            </td>
          </tr>
          <tr>
