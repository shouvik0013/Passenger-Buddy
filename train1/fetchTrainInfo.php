<?php
    ...
    $test_qry1 = "SELECT `trainId` FROM `route_table` WHERE `stationId`=54 ORDER BY arrival ASC";
    $test_qry2 = "SELECT `trainId` FROM `route_table` WHERE `stationId`=52 ORDER BY arrival ASC";
